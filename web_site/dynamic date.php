...
header('Location: dynamic-dislpay.php');
...
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
	<label for='ToothParam[]'>To select multiple elements hold down the 'ctrl' key <br/><br/><b>Tooth Parameters</b><br/>Select data you would like displayed:</label><br>
	<select multiple="multiple" name="ToothParam[]" width="600" style="width: 600px">
	...
	<br/>
	<br/>
	<label for='SawDimensions[]'><b>Saw Dimensions</b><br/>Select data you would like displayed:</label><br>
	<select multiple="multiple" name="SawDimensions[]" width="600" style="width: 600px">
	...
	<br/>
	<br/>
	<label for='OperationData[]'><b>Operations Data</b><br/>Select data you would like displayed:</label><br>
	<select multiple="multiple" name="OperationData[]" width="600" style="width: 600px">
